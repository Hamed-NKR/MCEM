...
if ~ isempty(find(stat_par(:,1) > 1,1)) % checking particle exits from +x
    ...
    % ... particles
    r_par_new(inds_plus_x,1) = r_par_old(inds_plus_x,1) - ...
