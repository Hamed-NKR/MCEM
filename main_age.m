...
labels12 = num2str(std12(:,2));

if strcmp(plotlabel, 'on')
    text(1e9 * da21, 1e9 * dpp21, labels11, 'VerticalAlignment', 'bottom',...
        'HorizontalAlignment', 'right', 'FontSize', 8)
    text(1e9 * da21, 1e9 * dpp21, labels12, 'VerticalAlignment', 'top',...
        'HorizontalAlignment', 'left', 'FontSize', 8)
end
...
labels22 = num2str(std22(:,2));

if strcmp(plotlabel, 'on')
    text(1e9 * da22, 1e9 * dpp22, labels21, 'VerticalAlignment', 'bottom',...
        'HorizontalAlignment', 'right', 'FontSize', 8)
    text(1e9 * da22, 1e9 * dpp22, labels22, 'VerticalAlignment', 'top',...
        'HorizontalAlignment', 'left', 'FontSize', 8)
end
...
labels32 = num2str(std32(:,2));

if strcmp(plotlabel, 'on')
    text(1e9 * da23, 1e9 * dpp23, labels31, 'VerticalAlignment', 'bottom',...
        'HorizontalAlignment', 'right', 'FontSize', 8)
    text(1e9 * da23, 1e9 * dpp23, labels32, 'VerticalAlignment', 'top',...
        'HorizontalAlignment', 'left', 'FontSize', 8)
end
