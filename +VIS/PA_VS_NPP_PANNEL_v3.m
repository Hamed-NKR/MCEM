function h = PA_VS_NPP_PANNEL_v3(parsdata)
% "PA_VS_NPP_v3" plots the projected area over number of promaries vs. ...
...
ylabel('$\hat{\overline{A}}_{agg}/n_{pp}$ [-]', 'interpreter', 'latex', 'FontSize', 20)
